...
class GMC_Exclusion_Manager {
    ...
    private function remove_exclusion() {
        ...
        if (empty($product_id)) {
            add_settings_error('gmc_messages', 'gmc_message', __('Invalid product ID.', 'multi-currency-woo'), 'error');
            return;
        }
        ...
        if ($key !== false) {
            ...
            add_settings_error('gmc_messages', 'gmc_message', __('Product removed from exclusions.', 'multi-currency-woo'), 'success');
        } else {
            add_settings_error('gmc_messages', 'gmc_message', __('Product not found in exclusions.', 'multi-currency-woo'), 'error');
        }
