...
class GMC_Currency_Manager {
    ...
    private function add_currency() {
        ...
        if (empty($currency_code) || empty($currency_name) || $exchange_rate <= 0) {
            add_settings_error('gmc_messages', 'gmc_message', __('Please fill all required fields correctly.', 'multi-currency-woo'), 'error');
            return;
        }
        ...
        if ($result) {
            add_settings_error('gmc_messages', 'gmc_message', __('Currency added successfully.', 'multi-currency-woo'), 'success');
        } else {
            add_settings_error('gmc_messages', 'gmc_message', __('Failed to add currency. Currency code might already exist.', 'multi-currency-woo'), 'error');
        }
    }
    ...
    private function edit_currency() {
        ...
        if ($result !== false) {
            add_settings_error('gmc_messages', 'gmc_message', __('Currency updated successfully.', 'multi-currency-woo'), 'success');
        } else {
            add_settings_error('gmc_messages', 'gmc_message', __('Failed to update currency.', 'multi-currency-woo'), 'error');
        }
    }
    ...
    private function delete_currency() {
        ...
        if (empty($id)) {
            add_settings_error('gmc_messages', 'gmc_message', __('Invalid currency ID.', 'multi-currency-woo'), 'error');
            return;
        }
        ...
        if ($result) {
            add_settings_error('gmc_messages', 'gmc_message', __('Currency deleted successfully.', 'multi-currency-woo'), 'success');
        } else {
            add_settings_error('gmc_messages', 'gmc_message', __('Failed to delete currency.', 'multi-currency-woo'), 'error');
        }
